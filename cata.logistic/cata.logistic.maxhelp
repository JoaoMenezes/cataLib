...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 388.0, 320.0, 154.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 178.5, 335.0, 50.0, 20.0 ],
					"text" : "lambda"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 620.0, 230.0, 74.0, 20.0 ],
					"text" : "and so on..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 620.0, 258.0, 57.0, 18.0 ],
					"text" : "3.7 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 520.0, 230.0, 74.0, 20.0 ],
					"text" : "8 members "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 230.0, 74.0, 20.0 ],
					"text" : "4 members "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 258.0, 91.0, 18.0 ],
					"text" : "3.481499 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 340.0, 230.0, 74.0, 20.0 ],
					"text" : "2 members "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 248.5, 230.0, 80.0, 20.0 ],
					"text" : "one member"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 256.0, 57.0, 18.0 ],
					"text" : "2.3 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 258.0, 64.0, 18.0 ],
					"text" : "3.57 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.0, 258.0, 64.0, 18.0 ],
					"text" : "3.43 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 260.0, 294.0, 46.0, 20.0 ],
					"text" : "line 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 72.0, 437.0, 50.0, 20.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.0, 407.0, 41.0, 18.0 ],
					"text" : "$1 25"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 25.5, 272.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 25.5, 294.0, 65.0, 20.0 ],
					"text" : "metro 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.5, 287.0, 82.0, 20.0 ],
					"text" : "loadmess 3.4"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 125.5, 335.0, 50.0, 20.0 ]
				}

			}
, 			{
				"box" : 				{
					"color" : [ 1.0, 0.501961, 0.0, 0.57 ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-68",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 71.5, 365.0, 73.0, 20.0 ],
					"text" : "cata.logistic"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 125.5, 407.0, 138.0, 257.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 125.5, 70.0, 518.0, 22.0 ],
					"text" : "cata.logistic - Logistic function",
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 700.0, 125.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 269.5, 321.5, 135.0, 321.5 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 349.5, 284.5, 269.5, 284.5 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 529.5, 284.5, 269.5, 284.5 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 269.5, 283.5, 269.5, 283.5 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 429.5, 284.5, 269.5, 284.5 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 629.5, 284.5, 269.5, 284.5 ],
					"source" : [ "obj-58", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 81.0, 395.5, 135.0, 395.5 ],
					"source" : [ "obj-68", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 35.0, 345.0, 81.0, 345.0 ],
					"source" : [ "obj-73", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "header.png",
				"bootpath" : "/Users/JoaoMenezes/Documents/_work/Max/cataLib",
				"patcherrelativepath" : "../../../../../Documents/_work/Max/cataLib",
				"type" : "PNG ",
				"implicit" : 1
			}
, 			{
				"name" : "cata.logistic.maxpat",
				"bootpath" : "/Users/JoaoMenezes/Desktop/code-control/getParametrical/dependencies/cata.logistic",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
