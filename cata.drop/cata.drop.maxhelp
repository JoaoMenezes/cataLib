...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 409.833313, 382.0, 112.0, 20.0 ],
					"text" : "buffer~ drop 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 126.0, 69.0, 518.0, 22.0 ],
					"text" : "cata.drop - Drag, drop and manage multiple audio files.",
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 220.0, 382.0, 130.0, 18.0 ],
					"text" : "Path to Buffer~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 220.0, 410.0, 140.0, 60.0 ],
					"text" : "replace \"Macintosh HD:/Users/JoaoMenezes/Documents/_work/SoundDesign/MINI_byLuio/Editados/Acc_C.aif\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 177.0, 185.0, 53.0, 18.0 ],
					"text" : "clear all"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 210.0, 312.0, 100.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.333328, 222.0, 130.0, 18.0 ],
					"text" : "bang to delete selected file"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 210.0, 222.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.333328, 185.0, 37.0, 18.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.333313, 185.0, 111.0, 19.0 ],
					"text" : "drop a files here...",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 297.333313, 162.0, 139.0, 65.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 350.5, 375.0, 419.333313, 375.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 236.833328, 299.5, 219.5, 299.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 219.5, 345.0, 393.333313, 345.0, 393.333313, 248.0, 350.5, 248.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 219.5, 346.0, 392.333313, 346.0, 392.333313, 247.0, 263.166656, 247.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "cata.drop.maxpat",
				"bootpath" : "/Users/JoaoMenezes/Documents/_work/Max/cataLib/cata.drop",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
