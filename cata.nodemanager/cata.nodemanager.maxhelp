...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 562.0, 107.0, 148.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 126.0, 61.0, 523.0, 38.0 ],
					"text" : "cata.nodemanager -  Recursive node manager.  Add and Remove an infinite number of Nodes. Navigate through the menu and resize each one. ",
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 417.0, 150.0, 20.0 ],
					"text" : "Node data"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 437.0, 225.0, 18.0 ],
					"text" : "0.456522 0.394558 0.22 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 95.0, 385.0, 368.0, 367.5 ],
					"varname" : "PulseNodes",
					"xplace" : [ 0.456522 ],
					"yplace" : [ 0.394558 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 95.0, 307.0, 290.0, 20.0 ],
					"text" : "cata.nodemanager"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 375.0, 239.0, 32.0, 18.0 ],
					"text" : "Size"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 366.0, 257.0, 75.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 298.25, 239.0, 65.0, 18.0 ],
					"text" : "Node Index"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 162.75, 264.0, 40.0, 27.0 ],
					"text" : "-"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 95.0, 264.0, 40.0, 27.0 ],
					"text" : "+ "
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 298.25, 257.0, 66.75, 20.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 375.5, 335.0, 447.0, 335.0, 447.0, 225.0, 375.5, 225.0 ],
					"source" : [ "obj-1", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 194.833328, 365.5, 680.5, 365.5 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 285.166656, 342.0, 498.666687, 342.0, 498.666687, 214.0, 307.75, 214.0 ],
					"source" : [ "obj-1", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 279.0, 759.0, 57.0, 759.0, 57.0, 239.0, 240.0, 239.0 ],
					"source" : [ "obj-127", 1 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "cata.nodemanager.maxpat",
				"bootpath" : "/Users/JoaoMenezes/Documents/_work/Max/cataLib/cata.nodemanager",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
